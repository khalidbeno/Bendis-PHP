...
@section('css')
  <link rel="stylesheet" href="{{ asset('css/producto1.css') }}?v={{ time() }}">
@endsection
    ...
    <div class="product-container">
        ...
        <section class="product-grid">
            ...
            <figure class="product-image-container">
                <img src="{{ asset('img/Tapete.png') }}" alt="Tapete Bendis" class="product-image">
            ...
            <article class="product-content">
                ...
                <div class="product-price-container">
                    <strong class="product-price">9,90 €</strong>
                    <span class="product-shipping">Envío gratis</span>
                </div>

                <div class="product-actions">
                    <form action="{{ route('carrito.agregar', ['producto_id' => 1]) }}" method="POST">
                        @csrf
