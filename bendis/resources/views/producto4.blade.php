    ...
    <div class="product-container">
        ...
        <section class="product-grid">
            ...
            <figure class="product-image-container">
                <img src="{{ asset('img/Clip.png') }}" alt="Tapete Bendis" class="product-image">
            ...
            <article class="product-content">
                ...
                <div class="product-price-container">
                    <strong class="product-price">7,90 €</strong>
                    <span class="product-shipping">Envío gratis</span>
                </div>

                <div class="product-actions">
                    <form action="{{ route('carrito.agregar', ['producto_id' => 4]) }}" method="POST">
                        @csrf
